...
The pure `no_std` core of [`rusty_rtos_demo`](https://crates.io/crates/rusty_rtos_demo):
...
Part of Kairos (Remade With Rust). Plan: `docs/plans/rusty_rtos_demo.md` in the repo.
