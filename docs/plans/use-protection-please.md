# rusty_rtos_demo — hardening audit
...
**Unit**: `rusty_rtos_demo` — package (facade + `no_std` core)
**Tier**: standard — the standard demo task corpus and the sim runner: a development deliverable that exercises the kernel; no untrusted input
